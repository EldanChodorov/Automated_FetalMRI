...
"border-style: outset;")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../../../.designer/backup/images/purple_square.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-style: outset;")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../../../../.designer/backup/images/paintbrush.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-style: outset;")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../../../../.designer/backup/images/red_square.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-style: outset;")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../../../../.designer/backup/images/erase.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-style: outset;")
    ...
    def retranslateUi(self, workspace):
        ...
        self.pushButton.setToolTip(_translate("workspace", "Mark middle first and last frame with square CONTAINED in brain."))
        self.square_btn.setToolTip(_translate("workspace", "Mark middle frame with square ENCLOSING brain."))
